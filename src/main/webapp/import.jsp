...
if (StringUtils.indexOfIgnoreCase(User_Agent, "MSIE") > -1 && (StringUtils.indexOfIgnoreCase(User_Agent, "MSIE 6") > -1 || StringUtils.indexOfIgnoreCase(User_Agent, "MSIE 7") > -1 || StringUtils.indexOfIgnoreCase(User_Agent, "MSIE 8") > -1)) {
	out.print("=====1======");
	out.println("<script src='" + contextPath + "/jslib/script/jquery-1.9.1.js' type='text/javascript' charset='utf-8'></script>");
} else {
	out.print("=====2======");
	out.println("<script src='" + contextPath + "/jslib/script/jquery-2.0.3.js' type='text/javascript' charset='utf-8'></script>");
}
%>
<%-- 引入jquery扩展 --%>
...
<%-- 引入easyui扩展 --%>
<script src="<%=contextPath%>/jslib/jsPlugin/util/syExtEasyUI.js" type="text/javascript" charset="utf-8"></script>
<%-- 引入扩展图标 --%>
...
<%-- 引入javascript扩展 --%>
<script src="<%=contextPath%>/jslib/jsPlugin/util/syExtJavascript.js" type="text/javascript" charset="utf-8"></script>
