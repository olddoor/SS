	...
	<fieldset style="width:300px">
		...
		<ul class="g-formlist">
			<li>
				...
				<div>
					<input type="text" value="<%=u.getLoginName()%>" name="loginName" class="g-text-entry" placeholder="请输入4-10字符" />
			...
			<li>
				<label>姓 名</label>
				<div class="write">
					<input type="text" value="<%=u.getUserName()%>" name="userName" class="g-text-entry" placeholder="请输入4-10字符" />
					<span class="tip" data-initial="请输入4-10字符"></span>
				</div>
			</li>
			<li>
				<label>密 码</label>
				<div class="write">
					<input type="text" value="<%=u.getPassword()%>" name="password" placeholder="请输入6-30字符" />
